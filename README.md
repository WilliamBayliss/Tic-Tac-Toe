...
A game of tic tac toe in Ruby! I've been following the tutorial at codequizzes to set it up, but there are some syntactical changes especially in the rspec files to account for new version changes.
